...
export class CitiesController {
     ...
     */ else if (city && total) {
      ...
      const faqs = [
        ...
        },
        {
          ...
          answer: `För att snabbt hitta och hyra ${Available[type_formatted]} i ${name} behöver du kontakta privata hyresvärdar som inte tillämpar bostadskö. Dessa privata hyresvärdar hittar du här på Frontend. Vi har lediga ${Plural[type_formatted]} från tusentals hyresvärdar.`,
        },
        {
          question: `Vilka typer av bostäder kan man hyra i ${name}?`,
          answer: `I ${name} kan man hyra [lägenheter](https://frontend.nytrek.dev/hyra-lagenhet/${city_formatted}), [hus](https://frontend.nytrek.dev/hyra-hus/${city_formatted}), [rum](https://frontend.nytrek.dev/hyra-rum/${city_formatted}) och [stugor](https://frontend.nytrek.dev/hyra-stuga/${city_formatted}). Du kan se alla lediga bostäder i ${name} [här](https://frontend.nytrek.dev/hyra-bostad/${city_formatted})!`,
        },
        {
          question: `Vilken är den bästa hemförsäkringen för ${Plural[type_formatted]} i ${name}?`,
          answer: `Den bästa hemförsäkringen just nu enligt redaktionen på Frontend är [Hedvig](https://frontend.nytrek.dev/blogg/maste-man-ha-hemforsakring). Hedvig erbjuder ett omfattande skydd till låga priser. Processen för att skapa konto är mycket smidig och eventuella försäkringsärenden hanteras snabbt. 25% av intäkterna går till Hedvig och 75% går till en gemensam skadepool. Eventuellt överskott doneras till välgörenhet i slutet av året.`,
        },
      ];
  ...
  async findType(@Param("type_formatted") type_formatted: string) {
    ...
    const faqs = [
      ...
      {
        question: `Vilka typer av bostäder kan man hyra i ${name}?`,
        answer: `I ${name} kan man hyra [lägenheter](https://frontend.nytrek.dev/hyra-lagenhet/), [hus](https://frontend.nytrek.dev/hyra-hus/), [rum](https://frontend.nytrek.dev/hyra-rum/) och [stugor](https://frontend.nytrek.dev/hyra-stuga/). Du kan se alla lediga bostäder i Sverige [här](https://frontend.nytrek.dev/hyra-bostad/)`,
      },
      {
        question: `Vilken är den bästa hemförsäkringen för ${Plural[type_formatted]} i ${name}?`,
        answer: `Den bästa hemförsäkringen just nu enligt redaktionen på Frontend är [Hedvig](https://frontend.nytrek.dev/blogg/maste-man-ha-hemforsakring). Hedvig erbjuder ett omfattande skydd till låga priser. Processen för att skapa konto är mycket smidig och eventuella försäkringsärenden hanteras snabbt. 25% av intäkterna går till Hedvig och 75% går till en gemensam skadepool. Eventuellt överskott doneras till välgörenhet i slutet av året.`,
